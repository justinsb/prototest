...
func (Person_PhoneType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2b0a391e05b91267, []int{0, 0}
}
...
func (*Person) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b0a391e05b91267, []int{0}
}
...
type Person_PhoneNumber struct {
	...
	Type                 Person_PhoneType `protobuf:"varint,2,opt,name=type,proto3,enum=prototest.Person_PhoneType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*AddressBook) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b0a391e05b91267, []int{1}
}
...
func init() { proto.RegisterFile("pb/prototest.proto", fileDescriptor_2b0a391e05b91267) }

var fileDescriptor_2b0a391e05b91267 = []byte{
	// 273 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Person) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.Phones) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintPrototest(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x22
		}
	...
	if len(m.Email) > 0 {
		i -= len(m.Email)
		copy(dAtA[i:], m.Email)
		i = encodeVarintPrototest(dAtA, i, uint64(len(m.Email)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
	...
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintPrototest(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Person_PhoneNumber) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Type != 0 {
		i = encodeVarintPrototest(dAtA, i, uint64(m.Type))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Number) > 0 {
		...
		i = encodeVarintPrototest(dAtA, i, uint64(len(m.Number)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Person_PhoneNumber) Size() (n int) {
	...
	if m.Type != 0 {
		n += 1 + sovPrototest(uint64(m.Type))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func skipPrototest(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupPrototest
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupPrototest = fmt.Errorf("proto: unexpected end of group")
)
